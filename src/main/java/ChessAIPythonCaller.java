...
public class ChessAIPythonCaller {
    ...
    public static String[] getBestMove(String fen) {
        try {
            ...
            ProcessBuilder pb = new ProcessBuilder("./.venv/bin/python3", "./src/NNBot/FEN_to_BestMove.py", fen);
    ...
    public static void main(String[] args) {
        String fen = "rnbqkb1r/pppppppp/7n/8/8/1P1PPPP1/P1P4P/RNBQKBNR w KQkq - 0 0";
